...
import static ryey.easer.plugins.condition.calendar.CalendarConditionMatchType.EVENT_TITLE;

public class CalendarPluginViewFragment extends PluginViewFragment<CalendarConditionData> {

    private final static String ACTION_RETURN = "ryey.easer.plugins.condition.calendar.RETURN_FROM_DIALOG";
    private final static String EXTRA_CALENDAR_ID = "ryey.easer.plugins.condition.calendar.extra.calendar_id";
    private final static String EXTRA_CALENDAR_NAME = "ryey.easer.plugins.condition.calendar.extra.calendar_name";
