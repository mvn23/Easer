...
import static ryey.easer.plugins.condition.calendar.CalendarHelper.activeEventsCount;
import static ryey.easer.plugins.condition.calendar.CalendarHelper.currentEvent_match_end;
import static ryey.easer.plugins.condition.calendar.CalendarHelper.nextEvent_match_start;

public class CalendarTracker extends SkeletonTracker<CalendarConditionData> {

    private static final String ACTION_UPDATE= "ryey.easer.plugins.condition.calendar.UPDATE";
